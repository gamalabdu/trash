  ...
  return (
    <div className='inner-work-container'>
            ...
            <div style={{ height: "100%", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
              {
                ...
                videos.map( (video, idx) => {
                  return <video key={idx} style={{ width:"90%", padding:"2%"}} src={video} autoPlay controls muted />
                })
              }
            </div>
            {
...

       {
        ...
        <div style={{ padding:"2%", display:"flex", justifyContent:"center", alignItems:"center", alignContent:"center", textAlign:"center"}}>
         
            <div>
              {
                canvas.map( (canva, idx) => {
                  return (
                    <video key={idx} style={{ width:"30%", height:"50%", borderRadius:"20px", margin:"0 5px"}} src={canva} autoPlay controls muted loop />
                  )
                })
              }
            </div>
