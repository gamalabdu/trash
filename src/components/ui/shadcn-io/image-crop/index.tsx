...
export type ImageCropApplyProps = React.ButtonHTMLAttributes<HTMLButtonElement>;
...
export type ImageCropResetProps = React.ButtonHTMLAttributes<HTMLButtonElement>;
